...
export const projectsData = [
    ...
    },
    {
        ...
        fullDescription: 'تم تطوير تطبيق عين الأمن للموبايل باستخدام Flutter  لتوفير تجربة مستخدم سلسة وسهلة الاستخدام. يتيح التطبيق للمواطنين إرسال البلاغات الأمنية مع تحديد موقعهم بدقة، ومتابعة حالة البلاغات في الوقت الفعلي.',
